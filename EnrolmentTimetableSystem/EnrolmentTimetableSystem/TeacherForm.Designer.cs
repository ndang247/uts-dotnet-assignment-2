namespace EnrolmentTimetableSystem
{
	partial class TeacherForm
	{
		...
		private void InitializeComponent()
		{
			...
			label2.Location = new Point(449, 235);
			label2.Name = "label2";
			label2.Size = new Size(111, 21);
			label2.TabIndex = 7;
			label2.Text = "Teacher Page";
			// 
			// label1
			// 
			label1.AutoSize = true;
			label1.Font = new Font("Segoe UI", 12F, FontStyle.Bold, GraphicsUnit.Point);
			label1.Location = new Point(413, 214);
			label1.Name = "label1";
			...
			pictureBox2.Location = new Point(475, 156);
			...
			// 
			requestMessageTextBox.Location = new Point(493, 176);
			requestMessageTextBox.Multiline = true;
			requestMessageTextBox.Name = "requestMessageTextBox";
			requestMessageTextBox.Size = new Size(305, 113);
			...
			teacherSubjectsComboBox.Location = new Point(117, 176);
			...
			textBox16.Location = new Point(117, 151);
			...
			textBox15.Location = new Point(493, 151);
			textBox15.Multiline = true;
			textBox15.Name = "textBox15";
			textBox15.Size = new Size(203, 37);
			textBox15.TabIndex = 5;
			textBox15.Text = "Please specify a reason";
			// 
			// textBox1
			// 
			...
			textBox3.Location = new Point(67, 89);
			...
			textBox2.Location = new Point(311, 13);
			...
			viewActivities.Controls.Add(textBox6);
